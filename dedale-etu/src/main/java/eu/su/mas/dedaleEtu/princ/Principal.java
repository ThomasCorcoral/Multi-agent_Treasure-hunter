...
public class Principal {
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		ag=createNewDedaleAgent(c, agentName, AgentOptimized.class.getName(), entityParametersExplo3);
		agentList.add(ag);
		// A4
		c = containerList.get(ConfigurationFile.LOCAL_CONTAINER2_NAME);
		Assert.assertNotNull("This container does not exist",c);
		...
		ag=createNewDedaleAgent(c, agentName, AgentOptimized.class.getName(), entityParametersExplo4);
		agentList.add(ag);
		// A5
		c = containerList.get(ConfigurationFile.LOCAL_CONTAINER2_NAME);
		Assert.assertNotNull("This container does not exist",c);
		...
		ag=createNewDedaleAgent(c, agentName, AgentOptimized.class.getName(), entityParametersExplo5);
		agentList.add(ag);
		// A6
		c = containerList.get(ConfigurationFile.LOCAL_CONTAINER2_NAME);
		Assert.assertNotNull("This container does not exist",c);
		...
		ag=createNewDedaleAgent(c, agentName, AgentOptimized.class.getName(), entityParametersExplo6);
		agentList.add(ag);
		
		//G1
		agentName="G1";        
		Object [] entityParametersG={"My parameters"};
		ag=createNewDedaleAgent(c, agentName, DummyWumpusShift2.class.getName(), entityParametersG);    
		agentList.add(ag);  
		//G2
		agentName="G2";        
